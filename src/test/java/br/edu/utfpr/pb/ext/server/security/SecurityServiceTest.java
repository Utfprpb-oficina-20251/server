...
class SecurityServiceTest {
  ...
  /**
   * Testa o cenário de borda onde o projeto existe, mas sua equipe executora está vazia. O
   * resultado esperado é 'false', pois o usuário não pode pertencer a uma equipe vazia.
   */
  @Test

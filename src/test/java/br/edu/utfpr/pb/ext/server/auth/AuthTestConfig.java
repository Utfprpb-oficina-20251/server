...
public class AuthTestConfig {
   ...
   * e-mail no contexto "autenticacao".
   *
   ...
   *
   * <p>O mock retorna {@code true} apenas quando o e-mail, contexto e código correspondem aos
   * valores de teste válidos. Para qualquer código inválido, retorna {@code false},
   * independentemente do e-mail ou contexto.
   *
   * @return instância mockada de EmailCodeValidationService com respostas controladas para cenários
   *     de teste
   */
  @Bean
  @Primary
  ...
  /**
   * Retorna um mock de {@link EmailOtpAuthenticationProvider} para testes de autenticação OTP por
   * e-mail.
   *
   * <p>O mock autentica com sucesso apenas quando o e-mail e o código correspondem aos valores de
   * teste predefinidos. Caso contrário, lança exceções para simular falhas de autenticação, como
   ...
   * @return mock de {@code EmailOtpAuthenticationProvider} com comportamento controlado para
   *     cenários de teste
   */
  @Bean
  @Primary

...
/* 1 ▸ SEQUÊNCIA ------------------------------------------------------------ */
CREATE SEQUENCE IF NOT EXISTS tb_departamento_seq
    START WITH 1
    INCREMENT 1;            -- ← “BY” removido (H2 não aceita)

/* 2 ▸ TABELA --------------------------------------------------------------- */
CREATE TABLE IF NOT EXISTS tb_departamento (
                                               id              BIGINT DEFAULT nextval('tb_departamento_seq') PRIMARY KEY,
...
/* 5 ▸ OBS.: Crie a FK para tb_usuario em migration posterior

...
CREATE TABLE tb_sugestao_de_projeto (
    id BIGSERIAL PRIMARY KEY,
    aluno_id BIGINT NOT NULL,
    professor_id BIGINT NOT NULL,
    curso_id BIGINT NOT NULL,
    descricao TEXT,
    CONSTRAINT fk_sugestao_aluno FOREIGN KEY (aluno_id) REFERENCES tb_usuario(id),
    CONSTRAINT fk_sugestao_professor FOREIGN KEY (professor_id) REFERENCES tb_usuario(id),
    CONSTRAINT fk_sugestao_curso FOREIGN KEY (curso_id) REFERENCES tb_curso(id)
);

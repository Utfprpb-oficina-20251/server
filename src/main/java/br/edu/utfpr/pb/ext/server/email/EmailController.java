...
public class EmailController {
    ...
    /**
     * Valida se o parâmetro de tipo foi informado.
     *
    ...
    /**
     * Converte uma string para o enum TipoCodigo.
     *
     * @param type string que representa o tipo de código
     * @return objeto TipoCodigo correspondente

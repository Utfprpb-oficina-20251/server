...
public class UsuarioController extends CrudController<Usuario, UsuarioServidorResponseDTO, Long> {
   ...
   * @return resposta HTTP contendo o token JWT e a data de expiração em caso de sucesso, ou HTTP
   *     400 se a autoridade não for encontrada
   */
  @Operation(
   ...
   * @return resposta HTTP com o token de autenticação e tempo de expiração, ou erro 400 se a
   *     autoridade não for encontrada
   */
  @Operation(
  ...
  /**
   * Cria uma resposta HTTP contendo um token JWT e tempo de expiração após salvar o usuário com a
   * autoridade fornecida.
   *
   * <p>Retorna HTTP 400 se a autoridade informada for nula.
   *
   ...
   * @return resposta HTTP com o DTO de login contendo o token e a expiração, ou HTTP 400 se a
   *     autoridade for nula
   */

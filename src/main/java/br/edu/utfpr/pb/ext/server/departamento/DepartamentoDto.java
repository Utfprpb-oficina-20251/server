...
/**
 * DTO utilizado para transferir dados da entidade Departamento entre as camadas da aplicação
...
public class DepartamentoDto {
  ...
  @NotBlank(message = "Sigla é obrigatória") @Size(max = 20, message = "Sigla deve ter no máximo 20 caracteres") private String sigla;

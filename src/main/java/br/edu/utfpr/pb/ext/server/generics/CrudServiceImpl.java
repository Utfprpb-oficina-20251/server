...
public abstract class CrudServiceImpl<T, ID extends Serializable>
    ...
    /**
 * Retorna a instância de {@link JpaRepository} responsável pelas operações de persistência para a entidade.
 *
...
protected abstract JpaRepository<T, ID> getRepository();
     ...
     * @return {@code true} se uma entidade com o ID especificado existir, caso contrário {@code false}
     */
    @Override
